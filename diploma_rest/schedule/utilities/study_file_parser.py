...
def department_to_model(bs_file):
    ...
    for item in info:
        ...
        tmp_department.code = parse_val_into_field(str, item, 'Код', tmp_department, 'code')

        tmp_department.shortname = parse_val_into_field(str, item, 'Сокращение', tmp_department, 'shortname')

        tmp_department.fullname = parse_val_into_field(str, item, 'Название', tmp_department, 'fullname')

        tmp_department.extid = parse_val_into_field(str, item, 'Код', tmp_department, 'extid')
